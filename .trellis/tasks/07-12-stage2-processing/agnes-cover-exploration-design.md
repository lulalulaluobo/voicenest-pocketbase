...
**状态**：已终止，功能已删除
**目标**：该探索已于 2026-07-15 终止；用户改用 Gemini/GPT 网页端自行生成和编辑封面，再在微信公众号后台上传。

## 终止决策

- 删除 Agnes Worker 接口、生产密钥、生图提示词、参考图、封面生成、本地图片缓存与自动上传永久素材。
- 保留公众号提示词管理、ASR 原文改写、排版预览、草稿箱发布和默认封面回退。
- 本文保留为技术决策历史，不再作为开发说明执行。
